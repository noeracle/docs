...
## v1 — production multi-publisher oracle (Tranche 1)

Audited, threshold-signed, mainnet.

- 3-of-5 Ed25519 threshold publisher set (2 self-operated, 3 external)
- Independent security audit (Trail of Bits, OtterSec, or equivalent)
...
## v2 — RWA data primitives (Tranche 2)
...
## v3 — decentralization and sustainability (Tranche 3)
...
Tranche 0 (v0) shipped pre-SCF. Tranches 1–3 are the subject of [SCF #44](https://communityfund.stellar.org/). The entire grant is allocated to product, infrastructure, audit, publisher onboarding, and bug bounty — the team takes no founder compensation through Tranche 3.

## See also

- [Architecture](architecture.md) — v0 system design
- [Threat model](threat-model.md) — v0 trust assumptions and what arrives in v1
